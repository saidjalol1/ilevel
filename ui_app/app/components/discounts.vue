<template>
  <div id="products-section" class="bg-gray-50 py-8 px-4 sm:px-6 lg:px-8">
      <div class="max-w-7xl mx-auto">
          <!-- Tabs Navigation -->
        <div class="flex gap-6 sm:gap-8 overflow-x-auto mb-8 scrollbar-hide">
              <h1 class="font-bold text-3xl">50% gacha chegirmalar</h1>      
        </div>
